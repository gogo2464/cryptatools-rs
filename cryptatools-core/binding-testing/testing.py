...
printable_alphabet_list = [
    Encoding(str=" ", bytes=[0x20]),
    Encoding(str="!", bytes=[0x21]),
    Encoding(str="\"", bytes=[0x22]),
    Encoding(str="#", bytes=[0x23]),
    Encoding(str="$", bytes=[0x24]),
    Encoding(str="%", bytes=[0x25]),
    Encoding(str="&", bytes=[0x26]),
    Encoding(str="'", bytes=[0x27]),
    Encoding(str="(", bytes=[0x28]),
    Encoding(str=")", bytes=[0x29]),
    Encoding(str="*", bytes=[0x2a]),
    Encoding(str="+", bytes=[0x2b]),
    Encoding(str=",", bytes=[0x2c]),
    Encoding(str="-", bytes=[0x2d]),
    Encoding(str=".", bytes=[0x2e]),
    Encoding(str="/", bytes=[0x2f]),
    Encoding(str="0", bytes=[0x30]),
    Encoding(str="1", bytes=[0x31]),
    Encoding(str="2", bytes=[0x32]),
    Encoding(str="3", bytes=[0x33]),
    Encoding(str="4", bytes=[0x34]),
    Encoding(str="5", bytes=[0x35]),
    Encoding(str="6", bytes=[0x36]),
    Encoding(str="7", bytes=[0x37]),
    Encoding(str="8", bytes=[0x38]),
    Encoding(str="9", bytes=[0x39]),
    Encoding(str=":", bytes=[0x3a]),
    Encoding(str=";", bytes=[0x3b]),
    Encoding(str="<", bytes=[0x3c]),
    Encoding(str="=", bytes=[0x3d]),
    Encoding(str=">", bytes=[0x3e]),
    Encoding(str="?", bytes=[0x3f]),
    Encoding(str="@", bytes=[0x40]),
    Encoding(str="A", bytes=[0x41]),
    Encoding(str="B", bytes=[0x42]),
    Encoding(str="C", bytes=[0x43]),
    Encoding(str="D", bytes=[0x44]),
    Encoding(str="E", bytes=[0x45]),
    Encoding(str="F", bytes=[0x46]),
    Encoding(str="G", bytes=[0x47]),
    Encoding(str="H", bytes=[0x48]),
    Encoding(str="I", bytes=[0x49]),
    Encoding(str="J", bytes=[0x4a]),
    Encoding(str="K", bytes=[0x4b]),
    Encoding(str="L", bytes=[0x4c]),
    Encoding(str="M", bytes=[0x4d]),
    Encoding(str="N", bytes=[0x4e]),
    Encoding(str="O", bytes=[0x4f]),
    Encoding(str="P", bytes=[0x50]),
    Encoding(str="Q", bytes=[0x51]),
    Encoding(str="R", bytes=[0x52]),
    Encoding(str="S", bytes=[0x53]),
    Encoding(str="T", bytes=[0x54]),
    Encoding(str="U", bytes=[0x55]),
    Encoding(str="V", bytes=[0x56]),
    Encoding(str="W", bytes=[0x57]),
    Encoding(str="X", bytes=[0x58]),
    Encoding(str="Y", bytes=[0x59]),
    Encoding(str="Z", bytes=[0x5a]),
    Encoding(str="[", bytes=[0x5b]),
    Encoding(str="\\", bytes=[0x5c]),
    Encoding(str="],", bytes=[0x5d]),
    Encoding(str="^", bytes=[0x5e]),
    Encoding(str="_", bytes=[0x5f]),
    Encoding(str="`", bytes=[0x60]),
    Encoding(str="a", bytes=[0x61]),
    Encoding(str="b", bytes=[0x62]),
    Encoding(str="c", bytes=[0x63]),
    Encoding(str="d", bytes=[0x64]),
    Encoding(str="e", bytes=[0x65]),
    Encoding(str="f", bytes=[0x66]),
    Encoding(str="g", bytes=[0x67]),
    Encoding(str="h", bytes=[0x68]),
    Encoding(str="i", bytes=[0x69]),
    Encoding(str="j", bytes=[0x6a]),
    Encoding(str="k", bytes=[0x6b]),
    Encoding(str="l", bytes=[0x6c]),
    Encoding(str="m", bytes=[0x6d]),
    Encoding(str="n", bytes=[0x6e]),
    Encoding(str="o", bytes=[0x6f]),
    Encoding(str="p", bytes=[0x70]),
    Encoding(str="q", bytes=[0x71]),
    Encoding(str="r", bytes=[0x72]),
    Encoding(str="s", bytes=[0x73]),
    Encoding(str="t", bytes=[0x74]),
    Encoding(str="u", bytes=[0x75]),
    Encoding(str="v", bytes=[0x76]),
    Encoding(str="w", bytes=[0x77]),
    Encoding(str="x", bytes=[0x78]),
    Encoding(str="y", bytes=[0x79]),
    Encoding(str="z", bytes=[0x7a]),
    Encoding(str="{", bytes=[0x7b]),
    Encoding(str="|", bytes=[0x7c]),
    Encoding(str="}", bytes=[0x7d]),
    Encoding(str="~", bytes=[0x7e])
]
