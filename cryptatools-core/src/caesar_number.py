...
class RustBuffer(ctypes.Structure):
    ...
    @staticmethod
    def alloc(size):
        return rust_call(_UniFFILib.ffi_caesar_number_4346_rustbuffer_alloc, size)

    @staticmethod
    def reserve(rbuf, additional):
        return rust_call(_UniFFILib.ffi_caesar_number_4346_rustbuffer_reserve, rbuf, additional)

    def free(self):
        return rust_call(_UniFFILib.ffi_caesar_number_4346_rustbuffer_free, self)
...
def loadIndirect():
    ...
    lib = libname.format("uniffi_caesar_number")
...
_UniFFILib.ffi_caesar_number_4346_rustbuffer_alloc.argtypes = (
    ctypes.c_int32,
    ctypes.POINTER(RustCallStatus),
)
_UniFFILib.ffi_caesar_number_4346_rustbuffer_alloc.restype = RustBuffer
_UniFFILib.ffi_caesar_number_4346_rustbuffer_from_bytes.argtypes = (
    ForeignBytes,
    ctypes.POINTER(RustCallStatus),
)
_UniFFILib.ffi_caesar_number_4346_rustbuffer_from_bytes.restype = RustBuffer
_UniFFILib.ffi_caesar_number_4346_rustbuffer_free.argtypes = (
    RustBuffer,
    ctypes.POINTER(RustCallStatus),
)
_UniFFILib.ffi_caesar_number_4346_rustbuffer_free.restype = None
_UniFFILib.ffi_caesar_number_4346_rustbuffer_reserve.argtypes = (
    RustBuffer,
    ctypes.c_int32,
    ctypes.POINTER(RustCallStatus),
)
_UniFFILib.ffi_caesar_number_4346_rustbuffer_reserve.restype = RustBuffer
...
class CaesarNumberAlgorithm:

    def __init__(self, alphabet):
        self.alphabet = alphabet

    def __str__(self):
        return "CaesarNumberAlgorithm(alphabet={})".format(self.alphabet)
...
class FfiConverterTypeCaesarNumberAlgorithm(FfiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return CaesarNumberAlgorithm(
            alphabet=FfiConverterString.read(buf),
        )

    @staticmethod
    def write(value, buf):
        FfiConverterString.write(value.alphabet, buf)
